...
//  bundle its executable lives in (`Audio.AppBundleIdentity`).
//
...
struct BrowserCallDetectionTests {
    ...
    private let zen = ProcessSelector(displayName: "Zen", bundlePrefix: "app.zen-browser.zen")
    private let vivaldi = ProcessSelector(displayName: "Vivaldi", bundlePrefix: "com.vivaldi.Vivaldi")
    private var installed: [ProcessSelector] { [zen, vivaldi] }
    ...
    @Test func aCataloguedBrowserResolvesToItsCuratedEntry() {
        ...
        let chromeFromBoth = CallAppCatalog.match(
            ...
            browsers: [ProcessSelector(displayName: "Google Chrome", bundlePrefix: "com.google.Chrome")]
        )
        ...
        let braveFromBoth = CallAppCatalog.match(
            ...
            browsers: [ProcessSelector(displayName: "Brave Browser", bundlePrefix: "com.brave.Browser")]
        )
    ...
    @Test func nativeMeetingAppsAreStillAttributedBeforeBrowsers() {
        ...
        let clients = [
            ...
            MicCaptureClient(pid: 101, bundleID: "us.zoom.xos", appBundleID: "us.zoom.xos"),
        ]
        let apps = CallAppCatalog.matchedApps(from: clients, browsers: installed)
