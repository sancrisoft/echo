...
//  CallDetectionTests
//
//  Only a curated set of meeting apps and browsers counts as "the user is in a
//  call". These tables pin both halves of that promise — the catalogued apps
//  (including their helper processes) match, and everything else, especially
//  near-miss identifiers, does not.
//
