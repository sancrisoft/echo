...
public struct CaptureRateGuard: Sendable {
    ...
    public static let continuitySlack = 0.02
    ...
    public static let maxCorrections = 3
    ...
    /// measurement noise.
    public static let standardRates: [Double] = [
        8_000, 11_025, 16_000, 22_050, 24_000, 32_000,
        44_100, 48_000, 88_200, 96_000, 176_400, 192_000,
    ]

    /// The rate the source claims — what the resampler is currently believing.
    public private(set) var declaredRate: Double
    public private(set) var correctionsApplied = 0
    ...
    public init(declaredRate: Double) {
    ...
    public var canCorrect: Bool { correctionsApplied < Self.maxCorrections }
    ...
    /// against it.
    public mutating func noteCorrection(to rate: Double) {
        declaredRate = rate
    ...
    public static func snapped(_ measured: Double) -> Double {
        guard
            let nearest = standardRates.min(by: {
